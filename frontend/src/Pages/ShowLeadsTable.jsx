...
const ShowLeadsTable = () => {
  const [data,setData]=useState("")
    ...
    console.log("leads",auth)
    console.log(auth._id)
    const handleData=async()=>{
            const res=await axios.get(`http://localhost:8080/distributeleads/${auth._id}`)
...
console.log("counsellor",data)
    ...
    const columns = [
      ...
      { name: "Phone", selector: (row) => row.phoneno, sortable: true },
