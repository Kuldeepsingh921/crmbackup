...
export default function CountryModal({name,bgcolor,hover,handleData,headername}) {
  ...
  const [countryname,setcountryName]=useState("")
    const handleClick=async()=>{
      ...
      const res=await axios.post("http://localhost:8080/mastercountry/addcountry",send)
        ...
        <Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <label htmlFor="">Country Name</label>
             <Input placeholder="Country Name" onChange={(e)=>setcountryName(e.target.value)}></Input>
            </ModalBody>
