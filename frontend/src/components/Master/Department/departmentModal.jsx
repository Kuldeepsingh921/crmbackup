...
export default function DepartmentModal({name,bgcolor,hover,handleData,headername}) {
  ...
  const [departmentname,setDepartmentName]=useState("")
    const handleClick=async()=>{
      ...
      const res=await axios.post("http://localhost:8080/masterdepartment/adddepartment",send)
        ...
        <Modal blockScrollOnMount={false} isOpen={isOpen} onClose={onClose}>
          ...
          <ModalContent>
            ...
            <label htmlFor="">Department Name</label>
             <Input placeholder="Department Name" onChange={(e)=>setDepartmentName(e.target.value)}></Input>
            </ModalBody>
            <ModalFooter>
